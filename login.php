                ...
                <div class="col-lg-7 px-5 pt-5">
                    <form action="login-process.php" method="POST">
                        <div class="form-row">
                            ...
                            <div class="col-lg-7">
                                <input type="email" placeholder="Email" class="form-control my-4 p-2 pl-5" name="email_cust">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <p>Belum Punya Akun <a href="pendaftaran.php">Buat Akun</a></p>

                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="index.php" style="color:#ffffff; font-size:30px">&#8592;</a>
                            </li>
                        </ul>
                    </form>
                </div>
