                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="<?= $data['id_kategori'] ?>">
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Name Kategori</label>
										<div class="col-sm-8 form-group">
											<input type="text" class="form-control" name="nama_kategori" placeholder="Name" value="<?= $data['nama_kategori'] ?>">
										</div>
