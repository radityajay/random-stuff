            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Store</h4>
											...
											foreach($store->all() as $data){
												?>
													<tr>
														...
														<td>
															<a class="btn btn-warning" href="edit.php?id=<?= $data['id_store'] ?>">Edit</a>
                                                            <a class="btn btn-danger" href="delete.php?id=<?= $data['id_store'] ?>">Delete</a>
														</td>
													</tr>
												<?php
											}
