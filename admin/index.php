                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered display no-wrap"
                                        ...
                                        <tbody>
										<?php
											foreach($admin->withRole() as $data){
												?>
													<tr>
														<td><?= $data['email'] ?></td>
														<td class="badge badge-success ml-3 mt-2"><?= $data['nama_role'] ?></td>
														<td>
															<a class="btn btn-warning" href="edit.php?id=<?= $data['id_admin'] ?>">Edit</a>
                                                            <a class="btn btn-danger" href="delete.php?id=<?= $data['id_admin'] ?>">Delete</a>
														</td>
													</tr>
												<?php
											}
