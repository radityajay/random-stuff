                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Brand</a></li>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="<?= $data['id_brand'] ?>">
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Name Brand</label>
										<div class="col-sm-8 form-group">
											<input type="text" class="form-control" name="nama_brand" placeholder="Name" value="<?= $data['nama_brand'] ?>">
										</div>
